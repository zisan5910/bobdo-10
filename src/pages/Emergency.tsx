  ...
  return (
    <Layout title="জরুরি যোগাযোগ">
      <div className="px-4 lg:px-8 space-y-4 lg:space-y-6">
            ...
            <CardContent className="p-4 lg:p-6">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-primary font-bold text-lg lg:text-xl mt-1">
                    {contact.number}
                  </p>
                </div>
                <Button
                  onClick={() => makeCall(contact.number)}
                  className="btn-ripple bg-success hover:bg-success/90 text-success-foreground rounded-full p-3 lg:p-4"
                >
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 lg:p-6 mt-6 lg:mt-8">
